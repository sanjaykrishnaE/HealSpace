  ...
  return profileData && (
    <div>
      ...
      <div className='flex flex-col gap-4 m-5'>
        <div>
          <img className='bg-lightblue/80 w-full sm:max-w-64 rounded-lg ' src={profileData.image} alt="" />
        </div>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          {
            isEdit 
            ?  <button onClick={updateProfile} className='px-4 py-1 border border-blue-400 text-sm rounded-lg mt-5 hover:bg-blue-500 hover:text-white transition-all'>Save</button>
            :  <button onClick={() => setIsEdit(true)} className='px-4 py-1 border border-blue-400 text-sm rounded-lg mt-5 hover:bg-blue-500 hover:text-white transition-all'>Edit</button>
          }
